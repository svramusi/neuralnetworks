...
public class Conv2DConnection extends ConnectionsImpl {
    ...
    public Conv2DConnection(Layer inputLayer, Layer outputLayer, int inputFeatureMapColumns, int inputFeatureMapRows, int inputFilters, int kernelRows, int kernelColumns,
            int outputFilters, int stride) {
    ...
    /**
     * When some dimension changes in the output layer the weights array changes
     * it's size
     */
